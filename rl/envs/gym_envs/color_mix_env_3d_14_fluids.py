...
class ColorMix3D14Fluid(ColorMix3D):
    ...
    def _get_pump_mapping(self):
        pump_mapping = {
            ...
            'r2': {'port': "/dev/ttyUSB3", 'channel': 3, 'fluid_type': Fluid([0.25, 0, 0, 0.75], "color")},
            'g2': {'port': "/dev/ttyUSB4", 'channel': 4, 'fluid_type': Fluid([0, 0.25, 0, 0.75], "color")},
            'b2': {'port': "/dev/ttyUSB5", 'channel': 5, 'fluid_type': Fluid([0, 0, 0.25, 0.75], "color")},

            'rg': {'port': "/dev/ttyUSB6", 'channel': 6, 'fluid_type': Fluid([0.45, 0.05, 0, 0.5], "color")},
            'rb': {'port': "/dev/ttyUSB7", 'channel': 7, 'fluid_type': Fluid([0.45, 0, 0.05, 0.5], "color")},

            'br': {'port': "/dev/ttyUSB9", 'channel': 9, 'fluid_type': Fluid([0.05, 0.0, 0.45, 0.5], "color")},
            'bg': {'port': "/dev/ttyUSB10", 'channel': 10, 'fluid_type': Fluid([0.0, 0.05, 0.45, 0.5], "color")},

            'gr': {'port': "/dev/ttyUSB11", 'channel': 11, 'fluid_type': Fluid([0.05, 0.45, 0.0, 0.5], "color")},
            'gb': {'port': "/dev/ttyUSB8", 'channel': 8, 'fluid_type': Fluid([0, 0.45, 0.05, 0.5], "color")},


            'w': {'port': "/dev/ttyUSB12", 'channel': 12, 'fluid_type': Fluid([0, 0.0, 0.0, 1], "color")},
            'w2': {'port': "/dev/ttyUSB13", 'channel': 13, 'fluid_type': Fluid([0, 0.0, 0.0, 1], "color")}
        }
        return pump_mapping


def run():
    env = gym.make('envs:ColorMix3D-v2')
